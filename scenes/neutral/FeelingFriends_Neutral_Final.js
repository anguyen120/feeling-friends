...
lib.ssMetadata = [
		{name:"FeelingFriends_Neutral_Final_atlas_1", frames: [[568,0,604,954],[0,0,566,1086],[584,1308,226,167],[917,1748,906,208],[0,1658,915,350],[584,956,915,350],[1174,795,408,157],[0,1088,582,568],[917,1308,528,438],[1174,0,613,793]]},
		{name:"FeelingFriends_Neutral_Final_atlas_2", frames: [[0,0,1208,1023],[1210,0,588,1450],[0,1025,1208,1023]]},
		{name:"FeelingFriends_Neutral_Final_atlas_3", frames: [[0,0,1661,2022]]}
];
...
(lib.Body_ArmLower_Back = function() {
	this.initialize(ss["FeelingFriends_Neutral_Final_atlas_1"]);
	this.gotoAndStop(0);
...
(lib.Body_Base = function() {
	this.initialize(ss["FeelingFriends_Neutral_Final_atlas_3"]);
	this.gotoAndStop(0);
}).prototype = p = new cjs.Sprite();
...
(lib.Body_Face_Base = function() {
	this.initialize(ss["FeelingFriends_Neutral_Final_atlas_2"]);
	this.gotoAndStop(0);
}).prototype = p = new cjs.Sprite();
...
if (reversed == null) { reversed = false; }
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_2).to({rotation:-5.7167,x:421.8,y:226.2},13).wait(66).to({startPosition:0},0).to({rotation:-2.2484,x:436.4,y:226.5},12).wait(28).to({startPosition:0},0).to({rotation:0,x:458.3,y:240.4},9).wait(95));

	// L_Eyebrow
	this.instance_3 = new lib.Body_Face_Eyebrow_L("synched",0);
	this.instance_3.setTransform(323.3,240.4,1,1,0,0,0,53.3,39.4);

	this.timeline.addTween(cjs.Tween.get(this.instance_3).to({regX:53.4,rotation:-5.7167,x:287.55,y:243.65},13).wait(66).to({startPosition:0},0).to({rotation:-2.2484,x:301.3,y:227.8},12).wait(28).to({startPosition:0},0).to({regX:53.3,rotation:0,x:323.3,y:240.4},9).wait(95));

	// R_Whiskers
	this.instance_4 = new lib.Body_Face_Whiskers_R("synched",0);
	this.instance_4.setTransform(658.2,547.2,1,1,0,0,0,124.2,121.2);

	this.timeline.addTween(cjs.Tween.get(this.instance_4).to({regX:124.3,regY:121.5,rotation:-27.6975,x:668.15,y:477.75},13).wait(66).to({startPosition:0},0).to({regX:124.4,rotation:-9.2298,x:659.2,y:516.5},12).wait(28).to({rotation:-9.2298},0).to({regX:124.2,regY:121.2,rotation:0,x:658.2,y:547.2},9).wait(95));

	// L_Whiskers
	this.instance_5 = new lib.Body_Face_Whiskers_L("synched",0);
	this.instance_5.setTransform(132.2,547.2,1,1,0,0,0,124.2,121.2);

	this.timeline.addTween(cjs.Tween.get(this.instance_5).to({regY:121.3,rotation:-20.722,x:171.95,y:622.3},13).wait(66).to({startPosition:0},0).to({regX:124.3,rotation:-2.2545,x:123.15,y:570.8},12).wait(28).to({startPosition:0},0).to({regX:124.2,regY:121.2,rotation:0,x:132.2,y:547.2},9).wait(95));

	// Mouth
	this.instance_6 = new lib.Body_Face_MouthClosed_1("synched",0);
	this.instance_6.setTransform(397.2,481.5,1,1,0,0,0,87.2,33.5);

	this.timeline.addTween(cjs.Tween.get(this.instance_6).to({regY:33.6,rotation:-5.7167,x:385,y:482.25},13).wait(66).to({startPosition:0},0).to({rotation:-2.2484,x:384.15,y:479.85},12).wait(28).to({startPosition:0},0).to({regY:33.5,rotation:0,x:397.2,y:481.5},9).wait(95));
	...
	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.instance_8}]}).to({state:[{t:this.instance_8}]},13).to({state:[{t:this.instance_9,p:{regX:187.2,regY:71.6,rotation:-5.7167,x:374.35,y:408.05}}]},26).to({state:[{t:this.instance_8}]},5).to({state:[{t:this.instance_8}]},35).to({state:[{t:this.instance_8}]},12).to({state:[{t:this.instance_8}]},28).to({state:[{t:this.instance_8}]},9).to({state:[{t:this.instance_9,p:{regX:182.6,regY:41.9,rotation:0,x:392.6,y:386.9}}]},39).to({state:[{t:this.instance_8}]},5).to({state:[{t:this.instance_9,p:{regX:182.6,regY:41.9,rotation:0,x:392.6,y:386.9}}]},5).to({state:[{t:this.instance_8}]},5).wait(41));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_10).to({rotation:-5.7167,x:376.75,y:391.45},13).wait(66).to({startPosition:0},0).to({regY:213.5,rotation:-2.2484,x:381.45,y:388.85},12).wait(28).to({startPosition:0},0).to({regY:213.4,rotation:0,x:398,y:390.4},9).wait(95));

	// R_ArmBottom_copy
	this.instance_11 = new lib.Body_Arm_R_Bottom("synched",0);
	this.instance_11.setTransform(494.7,1008.9,1,1,0,0,0,163.6,229.3);

	this.timeline.addTween(cjs.Tween.get(this.instance_11).wait(14).to({startPosition:0},0).wait(65).to({startPosition:0},0).to({regY:229.4,rotation:5.8152,x:552.5,y:985.35},22).wait(46).to({startPosition:0},0).to({regY:229.3,rotation:0,x:494.7,y:1008.9},11).wait(65));

	// R_ArmTop_copy
	this.instance_12 = new lib.Body_Arm_R_Top("synched",0);
	this.instance_12.setTransform(598.5,780.65,1,1,0,0,0,147.8,245.5);

	this.timeline.addTween(cjs.Tween.get(this.instance_12).wait(14).to({startPosition:0},0).wait(65).to({startPosition:0},0).to({regY:245.6,rotation:-9.1823,x:626.55,y:751.45},18).wait(50).to({startPosition:0},0).to({regY:245.5,rotation:0,x:598.5,y:780.65},11).wait(65));
	...
	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.instance_13}]}).to({state:[{t:this.instance_14}]},14).to({state:[{t:this.instance_14}]},65).to({state:[{t:this.instance_14}]},22).to({state:[{t:this.instance_14}]},46).to({state:[{t:this.instance_14}]},11).wait(65));
	this.timeline.addTween(cjs.Tween.get(this.instance_14).wait(14).to({_off:false},0).wait(65).to({startPosition:0},0).to({regX:181,rotation:1.2827,x:374.6,y:1045.95},22).wait(46).to({startPosition:0},0).to({regX:180.9,rotation:0,x:372.55,y:1032.45},11).wait(65));
	...
	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.instance_15}]}).to({state:[{t:this.instance_16}]},14).to({state:[{t:this.instance_16}]},65).to({state:[{t:this.instance_16}]},18).to({state:[{t:this.instance_16}]},50).to({state:[{t:this.instance_16}]},11).wait(65));
	this.timeline.addTween(cjs.Tween.get(this.instance_16).wait(14).to({_off:false},0).wait(65).to({startPosition:0},0).to({regX:126.5,rotation:1.2827,x:257.55,y:820},18).wait(50).to({startPosition:0},0).to({regX:126.4,rotation:0,x:250.5,y:809.1},11).wait(65));
	...
	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.instance_17}]}).to({state:[{t:this.instance_18}]},14).to({state:[{t:this.instance_18}]},65).to({state:[{t:this.instance_18}]},18).to({state:[{t:this.instance_18}]},50).to({state:[{t:this.instance_18}]},11).wait(65));
	this.timeline.addTween(cjs.Tween.get(this.instance_18).wait(14).to({_off:false},0).wait(65).to({startPosition:0},0).to({rotation:-4.7167,x:570.05,y:895.95},18).wait(50).to({startPosition:0},0).to({rotation:0,x:522.9,y:909.1},11).wait(65));

	// R_Leg
	this.instance_19 = new lib.Body_Leg();
	this.instance_19.setTransform(701.95,1055,0.3996,0.3996,0,0,180);

	this.timeline.addTween(cjs.Tween.get(this.instance_19).wait(223));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_23).wait(223));
...
lib.properties = {
	...
	manifest: [
		...
		{src:"images/FeelingFriends_Neutral_Final_atlas_1.png", id:"FeelingFriends_Neutral_Final_atlas_1"},
		{src:"images/FeelingFriends_Neutral_Final_atlas_2.png", id:"FeelingFriends_Neutral_Final_atlas_2"},
		{src:"images/FeelingFriends_Neutral_Final_atlas_3.png", id:"FeelingFriends_Neutral_Final_atlas_3"}
	],
	preloads: []
};
