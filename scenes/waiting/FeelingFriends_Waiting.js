...
lib.ssMetadata = [
		{name:"FeelingFriends_Waiting_atlas_1", frames: [[0,0,1661,2022]]},
		{name:"FeelingFriends_Waiting_atlas_2", frames: [[0,0,1208,1023],[1210,0,588,1450],[0,1025,1208,1023]]},
		{name:"FeelingFriends_Waiting_atlas_3", frames: [[568,0,604,954],[0,0,566,1086],[584,1308,226,167],[917,1748,906,208],[0,1658,915,350],[584,956,915,350],[1174,795,408,157],[0,1088,582,568],[917,1308,528,438],[1174,0,613,793]]}
];
...
(lib.Body_ArmLower_Back = function() {
	this.initialize(ss["FeelingFriends_Waiting_atlas_3"]);
	this.gotoAndStop(0);
...
(lib.Body_Base = function() {
	this.initialize(ss["FeelingFriends_Waiting_atlas_1"]);
	this.gotoAndStop(0);
}).prototype = p = new cjs.Sprite();
...
(lib.Body_Face_Base = function() {
	this.initialize(ss["FeelingFriends_Waiting_atlas_2"]);
	this.gotoAndStop(0);
}).prototype = p = new cjs.Sprite();
...
(lib.WaitingScreenText2 = function() {
	this.initialize(img.WaitingScreenText2);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,2034,2440);
...
// stage content:
(lib.FeelingFriends_Waiting = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
	...
	// Text
	this.instance_1 = new lib.WaitingScreenText2();
	...
	this.instance_13.setTransform(191.65,858.15,0.4449,0.4449,-13.7369);
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_22).wait(14).to({_off:false},0).wait(20).to({startPosition:0},0).to({regX:294.5,regY:249.4,rotation:-6.9517,x:761.55,y:1113.4},4).to({regX:294.4,regY:249.3,rotation:0,x:761.4,y:1121.3},3).to({regX:294.5,regY:249.4,rotation:-6.9517,x:761.55,y:1113.4},3).to({regX:294.4,regY:249.3,rotation:0,x:761.4,y:1121.3},3).wait(36).to({startPosition:0},0).to({regX:294.5,rotation:-8.4533,x:801.5,y:1105.3},16).wait(11).to({startPosition:0},0).to({regX:294.6,regY:249.4,rotation:6.5451,x:801.65,y:1105.35},4).to({regX:294.5,regY:249.3,rotation:-8.4533,x:801.5,y:1105.3},3).to({regX:294.6,regY:249.4,rotation:6.5451,x:801.65,y:1105.35},3).wait(27).to({startPosition:0},0).to({regX:294.4,regY:249.3,rotation:0,x:761.4,y:1121.3},11).wait(52));
	...
	// R_Eyebrow
	this.instance_24 = new lib.Body_Face_Eyebrow_R("synched",0);
	this.instance_24.setTransform(458.3,240.4,1,1,0,0,0,53.3,39.4);

	this.timeline.addTween(cjs.Tween.get(this.instance_24).to({rotation:-5.7167,x:421.8,y:226.2},13).wait(66).to({startPosition:0},0).to({rotation:-2.2484,x:436.4,y:226.5},12).wait(28).to({startPosition:0},0).to({rotation:0,x:458.3,y:240.4},9).wait(82));

	// L_Eyebrow
	this.instance_25 = new lib.Body_Face_Eyebrow_L("synched",0);
	this.instance_25.setTransform(323.3,240.4,1,1,0,0,0,53.3,39.4);

	this.timeline.addTween(cjs.Tween.get(this.instance_25).to({regX:53.4,rotation:-5.7167,x:287.55,y:243.65},13).wait(66).to({startPosition:0},0).to({rotation:-2.2484,x:301.3,y:227.8},12).wait(28).to({y:235.8},0).to({regX:53.3,rotation:0,x:323.3,y:240.4},9).wait(82));

	// R_Whiskers
	this.instance_26 = new lib.Body_Face_Whiskers_R("synched",0);
	this.instance_26.setTransform(658.2,547.2,1,1,0,0,0,124.2,121.2);

	this.timeline.addTween(cjs.Tween.get(this.instance_26).to({regX:124.3,regY:121.5,rotation:-27.6975,x:668.15,y:477.75},13).wait(66).to({startPosition:0},0).to({regX:124.4,rotation:-9.2298,x:659.2,y:516.5},12).wait(28).to({rotation:-9.2298},0).to({regX:124.2,regY:121.2,rotation:0,x:658.2,y:547.2},9).wait(82));

	// L_Whiskers
	this.instance_27 = new lib.Body_Face_Whiskers_L("synched",0);
	this.instance_27.setTransform(132.2,547.2,1,1,0,0,0,124.2,121.2);

	this.timeline.addTween(cjs.Tween.get(this.instance_27).to({regY:121.3,rotation:-20.722,x:171.95,y:622.3},13).wait(66).to({startPosition:0},0).to({regX:124.3,rotation:-2.2545,x:123.15,y:570.8},12).wait(28).to({startPosition:0},0).to({regX:124.2,regY:121.2,rotation:0,x:132.2,y:547.2},9).wait(82));

	// Mouth
	this.instance_28 = new lib.Body_Face_MouthClosed_1("synched",0);
	this.instance_28.setTransform(397.2,481.5,1,1,0,0,0,87.2,33.5);

	this.timeline.addTween(cjs.Tween.get(this.instance_28).to({regY:33.6,rotation:-5.7167,x:385,y:482.25},13).wait(66).to({startPosition:0},0).to({rotation:-2.2484,x:384.15,y:479.85},12).wait(28).to({startPosition:0},0).to({regY:33.5,rotation:0,x:397.2,y:481.5},9).wait(82));

	// Eyes_Pupils
	this.instance_29 = new lib.Body_Face_EyesOpen_Pupils_1("synched",0);
	this.instance_29.setTransform(396.3,390.8,1,1,0,0,0,203.3,77.8);

	this.timeline.addTween(cjs.Tween.get(this.instance_29).to({rotation:-5.7167,x:373.1,y:392},9).to({_off:true},30).wait(5).to({_off:false},0).wait(37).to({startPosition:0},0).to({rotation:-2.2484,x:393.7,y:377.55},8).wait(34).to({startPosition:0},0).to({x:377.7},7).wait(8).to({startPosition:0},0).to({rotation:0,x:396.3,y:390.8},13).to({_off:true},16).wait(5).to({_off:false},0).to({_off:true},5).wait(5).to({_off:false},0).wait(28));

	// Eyes_Base
	this.instance_30 = new lib.Body_Face_EyesOpen_Base_1("synched",0);
	this.instance_30.setTransform(394.1,384.5,1,1,0,0,0,187.1,71.5);

	this.instance_31 = new lib.Body_Face_EyesClosed_1("synched",0);
	this.instance_31.setTransform(374.35,408.05,1,1,-5.7167,0,0,187.2,71.6);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.instance_30}]}).to({state:[{t:this.instance_30}]},13).to({state:[{t:this.instance_31,p:{regX:187.2,regY:71.6,rotation:-5.7167,x:374.35,y:408.05}}]},26).to({state:[{t:this.instance_30}]},5).to({state:[{t:this.instance_30}]},35).to({state:[{t:this.instance_30}]},12).to({state:[{t:this.instance_30}]},28).to({state:[{t:this.instance_30}]},9).to({state:[{t:this.instance_31,p:{regX:182.6,regY:41.9,rotation:0,x:392.6,y:386.9}}]},39).to({state:[{t:this.instance_30}]},5).to({state:[{t:this.instance_31,p:{regX:182.6,regY:41.9,rotation:0,x:392.6,y:386.9}}]},5).to({state:[{t:this.instance_30}]},5).wait(28));
	this.timeline.addTween(cjs.Tween.get(this.instance_30).to({regX:187.2,regY:71.6,rotation:-5.7167,x:372.35,y:386.05},13).to({_off:true},26).wait(5).to({_off:false},0).wait(35).to({startPosition:0},0).to({rotation:-2.2484,x:377.35,y:383.1},12).wait(28).to({startPosition:0},0).to({regX:187.1,regY:71.5,rotation:0,x:394.1,y:384.5},9).to({_off:true},39).wait(5).to({_off:false},0).to({_off:true},5).wait(5).to({_off:false},0).wait(28));

	// Head_Base
	this.instance_32 = new lib.Body_Face_Base_1("synched",0);
	this.instance_32.setTransform(398,390.4,1,1,0,0,0,252,213.4);

	this.timeline.addTween(cjs.Tween.get(this.instance_32).to({rotation:-5.7167,x:376.75,y:391.45},13).wait(66).to({startPosition:0},0).to({regY:213.5,rotation:-2.2484,x:381.45,y:388.85},12).wait(28).to({startPosition:0},0).to({regY:213.4,rotation:0,x:398,y:390.4},9).wait(82));

	// R_ArmBottom_copy
	this.instance_33 = new lib.Body_Arm_R_Bottom("synched",0);
	this.instance_33.setTransform(494.7,1008.9,1,1,0,0,0,163.6,229.3);

	this.timeline.addTween(cjs.Tween.get(this.instance_33).wait(14).to({startPosition:0},0).wait(65).to({startPosition:0},0).to({regY:229.4,rotation:5.8152,x:552.5,y:985.35},22).wait(46).to({startPosition:0},0).to({regY:229.3,rotation:0,x:494.7,y:1008.9},11).wait(52));

	// R_ArmTop_copy
	this.instance_34 = new lib.Body_Arm_R_Top("synched",0);
	this.instance_34.setTransform(598.5,780.65,1,1,0,0,0,147.8,245.5);

	this.timeline.addTween(cjs.Tween.get(this.instance_34).wait(14).to({startPosition:0},0).wait(65).to({startPosition:0},0).to({regY:245.6,rotation:-9.1823,x:626.55,y:751.45},18).wait(50).to({startPosition:0},0).to({regY:245.5,rotation:0,x:598.5,y:780.65},11).wait(52));

	// L_ArmBottom
	this.instance_35 = new lib.Body_ArmLower_Back();
	this.instance_35.setTransform(191.65,858.15,0.4449,0.4449,-13.7369);

	this.instance_36 = new lib.Body_LArm_Bottom("synched",0);
	this.instance_36.setTransform(372.55,1032.45,1,1,0,0,0,180.9,238.1);
	this.instance_36._off = true;

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.instance_35}]}).to({state:[{t:this.instance_36}]},14).to({state:[{t:this.instance_36}]},65).to({state:[{t:this.instance_36}]},22).to({state:[{t:this.instance_36}]},46).to({state:[{t:this.instance_36}]},11).wait(52));
	this.timeline.addTween(cjs.Tween.get(this.instance_36).wait(14).to({_off:false},0).wait(65).to({startPosition:0},0).to({regX:181,rotation:1.2827,x:374.6,y:1045.95},22).wait(46).to({startPosition:0},0).to({regX:180.9,rotation:0,x:372.55,y:1032.45},11).wait(52));

	// L_ArmTop
	this.instance_37 = new lib.Body_ArmUpper();
	this.instance_37.setTransform(134.3,573.6,0.4288,0.4288,1.258);

	this.instance_38 = new lib.Body_LArm_Top("synched",0);
	this.instance_38.setTransform(250.5,809.1,1,1,0,0,0,126.4,235.5);
	this.instance_38._off = true;

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.instance_37}]}).to({state:[{t:this.instance_38}]},14).to({state:[{t:this.instance_38}]},65).to({state:[{t:this.instance_38}]},18).to({state:[{t:this.instance_38}]},50).to({state:[{t:this.instance_38}]},11).wait(52));
	this.timeline.addTween(cjs.Tween.get(this.instance_38).wait(14).to({_off:false},0).wait(65).to({startPosition:0},0).to({regX:126.5,rotation:1.2827,x:257.55,y:820},18).wait(50).to({startPosition:0},0).to({regX:126.4,rotation:0,x:250.5,y:809.1},11).wait(52));

	// Body
	this.instance_39 = new lib.Body_Base();
	this.instance_39.setTransform(158,465,0.4393,0.4393);

	this.instance_40 = new lib.Body_Base_1("synched",0);
	this.instance_40.setTransform(522.9,909.1,1,1,0,0,0,364.9,444.1);
	this.instance_40._off = true;

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.instance_39}]}).to({state:[{t:this.instance_40}]},14).to({state:[{t:this.instance_40}]},65).to({state:[{t:this.instance_40}]},18).to({state:[{t:this.instance_40}]},50).to({state:[{t:this.instance_40}]},11).wait(52));
	this.timeline.addTween(cjs.Tween.get(this.instance_40).wait(14).to({_off:false},0).wait(65).to({startPosition:0},0).to({rotation:-4.7167,x:570.05,y:895.95},18).wait(50).to({startPosition:0},0).to({rotation:0,x:522.9,y:909.1},11).wait(52));

	// R_Leg
	this.instance_41 = new lib.Body_Leg();
	this.instance_41.setTransform(701.95,1055,0.3996,0.3996,0,0,180);

	this.timeline.addTween(cjs.Tween.get(this.instance_41).wait(210));

	// L_Leg
	this.instance_42 = new lib.Body_Leg();
	this.instance_42.setTransform(258,1055,0.3996,0.3996);

	this.timeline.addTween(cjs.Tween.get(this.instance_42).wait(210));

	// Tail
	this.instance_43 = new lib.Body_Tail();
	this.instance_43.setTransform(467,872,0.4875,0.4875);

	this.instance_44 = new lib.Body_Tail_1("synched",0);
	this.instance_44.setTransform(761.4,1121.3,1,1,0,0,0,294.4,249.3);
	this.instance_44._off = true;

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.instance_43}]}).to({state:[{t:this.instance_44}]},14).to({state:[{t:this.instance_44}]},20).to({state:[{t:this.instance_44}]},4).to({state:[{t:this.instance_44}]},3).to({state:[{t:this.instance_44}]},3).to({state:[{t:this.instance_44}]},3).to({state:[{t:this.instance_44}]},36).to({state:[{t:this.instance_44}]},16).to({state:[{t:this.instance_44}]},11).to({state:[{t:this.instance_44}]},4).to({state:[{t:this.instance_44}]},3).to({state:[{t:this.instance_44}]},3).to({state:[{t:this.instance_44}]},27).to({state:[{t:this.instance_44}]},11).wait(52));
	this.timeline.addTween(cjs.Tween.get(this.instance_44).wait(14).to({_off:false},0).wait(20).to({startPosition:0},0).to({regX:294.5,regY:249.4,rotation:-6.9517,x:761.55,y:1113.4},4).to({regX:294.4,regY:249.3,rotation:0,x:761.4,y:1121.3},3).to({regX:294.5,regY:249.4,rotation:-6.9517,x:761.55,y:1113.4},3).to({regX:294.4,regY:249.3,rotation:0,x:761.4,y:1121.3},3).wait(36).to({startPosition:0},0).to({regX:294.5,rotation:-8.4533,x:801.5,y:1105.3},16).wait(11).to({startPosition:0},0).to({regX:294.6,regY:249.4,rotation:6.5451,x:801.65,y:1105.35},4).to({regX:294.5,regY:249.3,rotation:-8.4533,x:801.5,y:1105.3},3).to({regX:294.6,regY:249.4,rotation:6.5451,x:801.65,y:1105.35},3).wait(27).to({startPosition:0},0).to({regX:294.4,regY:249.3,rotation:0,x:761.4,y:1121.3},11).wait(52));

	// Background2
	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("rgba(0,0,102,0.149)").s().p("EhLACFyMAAAkLjMCWBAAAMAAAELjg");
	this.shape_1.setTransform(544.2,924.25);

	this.timeline.addTween(cjs.Tween.get(this.shape_1).wait(210));

	// Background
	this.instance_45 = new lib.StarterScreenBackground();
	this.instance_45.setTransform(0,0,1.7886,2.465);

	this.timeline.addTween(cjs.Tween.get(this.instance_45).wait(210));

	this._renderFirstFrame();

}).prototype = p = new lib.AnMovieClip();
p.nominalBounds = new cjs.Rectangle(534.2,960,595.0999999999999,1616.1999999999998);
// library properties:
lib.properties = {
	id: '12706E1F07A44E09B0893513AD7D6884',
	width: 1080,
	height: 1920,
	fps: 30,
	color: "#FFFFFF",
	opacity: 1.00,
	manifest: [
		{src:"images/WaitingScreenText2.png", id:"WaitingScreenText2"},
		{src:"images/FeelingFriends_Waiting_atlas_1.png", id:"FeelingFriends_Waiting_atlas_1"},
		{src:"images/FeelingFriends_Waiting_atlas_2.png", id:"FeelingFriends_Waiting_atlas_2"},
		{src:"images/FeelingFriends_Waiting_atlas_3.png", id:"FeelingFriends_Waiting_atlas_3"}
	],
	preloads: []
};
...
an.compositions['12706E1F07A44E09B0893513AD7D6884'] = {
